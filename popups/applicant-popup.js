...
import { openPersonPopup } from "./person-popup.js?v=26-07-08-04";
import { openPhotoPopup } from "./photo-popup.js?v=26-07-08-04";
...
async function getTemplate() {
  ...
  const response = await fetch("./popups/applicant-popup.html?v=26-07-08-04");
